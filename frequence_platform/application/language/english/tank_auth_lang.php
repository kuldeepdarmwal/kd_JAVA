...
$lang['auth_incorrect_login'] = 'Incorrect username';
...
$lang['auth_message_new_password_sent'] = "An email with your new password has been sent to you. Be sure to check your if your spam filter caught it if the mail doesn't show up.";
$lang['auth_message_new_password_activated'] = 'You have successfully reset your password';
$lang['auth_message_reset_password_email_sent'] = 'A password reset email has been sent. Follow the instructions in the email to reset your password.';
$lang['auth_message_reset_password_request_failed'] = 'We were unable to process your request. Please go back and try to submit the form again.';
...
$lang['auth_subject_reset_password'] = 'Your password on %s has been reset';
$lang['auth_subject_temp_password'] = 'Your new password on %s';
