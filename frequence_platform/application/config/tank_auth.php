...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'VantageLocal';
$config['webmaster_email'] = 'asfhklasfhklasfhkl@vantagelocal.com';
...
$config['username_max_length'] = 75; //20;
...
$config['login_attempt_expire'] = 60*5;  //five minutes
...
$config['forgot_password_expire'] = defined('TANK_AUTH_PASSWORD_RESET') ? TANK_AUTH_PASSWORD_RESET : 60*60*24*30;
