...
{   
    ...
    $table_body_string .= '<tr id = "'.$row_id.'" class="expand">
						...
						<div class="clickable_icon" onclick="add_to_healthcheck(\''.$row['advertiser'].'\',\''.$row['c_id'].'\','.$row_id.');"><img src="/images/campaign_health/eye_open.png" alt="Add" ></div>
...
//                                        && element.attributes['class'].value == 'filterable') {
			...
			$("table").stickyTableHeaders();
                ...
                function add_to_healthcheck(advertiser,campaign,id){
                            //alert(campaign);
                            $.ajax({
                                type: "GET",
                                url: "/campaign_health/add_to_healthcheck/",
                                data: { advertiser: advertiser, campaign: campaign },
                                dataType: 'html'
                                }).done(function( msg ) {
