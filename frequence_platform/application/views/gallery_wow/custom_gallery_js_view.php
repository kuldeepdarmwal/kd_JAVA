...
<script src="/libraries/external/isotope/jquery.isotope.min.js"></script>
	...
	function add_tile(existing_tiles,new_tile){
		...
		return existing_tiles+ '<div class="item ">\
								<a href="'+new_tile.preview_link+'" target="_blank">\
									<div class="thumb_wrapper">\
										<div class="view view-tenth">\
											<img id="'+new_tile.v_id+'" src="'+new_tile.thumb+'"  />\
											<div class="mask">\
												<img class="viewcreative" src="https://s3.amazonaws.com/brandcdn-assets/gallery_wow/vc_button.png" />\
											</div>\
										</div>\
										<div class="clrfix"></div>\
										<span class="ad_title">'+new_tile.saved_adset_name+'</span>\
									</div>\
								</a>\
								</div>';
	}
