...
if(isChrome && (isHTML5 || parentURL == "")) { <?php // force HTML if this is chrome and either: we have a swiffy, or we don't have a flash creative ?>
	forceHTML5 = "true";
}
var youTubeID;
...
?>		(function(){
			...
			setDynamicGeo = function(message) {
				...
				if (forceHTML5)
				{
					creativeObjectId = 'swiffycontainer-';
				}
...
function loadHTML5() {
	...
	document.write('<div id="'+ vlid +'-'+ clientID +'"class="vantagelocal" style="position:relative;width:' + dccreativewidth + 'px;height:' + dccreativeheight + 'px;" onmouseover="onHoverMaster();" onmouseout="onOutMaster();"><div class="buttons" style="z-index:3; position:absolute;"><div id="playbutton-'+clientID+'"></div></div><div style="position:absolute;left:' + video_x + 'px;top:' + video_y + 'px;z-index:2;" class="video-holder" id="holder"><div id="player-'+ clientID +'"></div></div><a href="' + advurl + '" target="'+vl_html_target+'"><span id="clicktag" style="width:100%;height:100%;position:absolute;left:0px;top:0px;z-index:1;background-color:rgba(0,0,0,0)"></span></a><div id="swiffycontainer-'+clientID+'" style="width: ' + dccreativewidth + 'px; height: ' + dccreativeheight + 'px" style="position:absolute;left:0px;top:0px;z-index:0;"></div></div><script type="text/javascript" src="' + swiffyJS + '"><\/script>');
}
