<!-- Vantage Local HTML/JS Tag version 7.0.0, authors: MM, SH, MR, Shaggy 2013.09.12 - Interactions etc -->
<?php 
...
var grandpaURL = "http://ad.vantagelocal.com/grandpa/richgrandpa_<?php echo $gpa_version;?>_<?php echo $creative_width;?>.swf";
var grandpaURLSSL = "https://7629e0040b7aa73eaefb-2105a7941d639194e8ba5253efec10c9.ssl.cf1.rackcdn.com/grandpa/richgrandpa_<?php echo $gpa_version;?>_<?php echo $creative_width;?>.swf";
...
if ( flashvars.forceHTML5 == "true" ) {
	forceHTML5 = flashvars.forceHTML5;
}
//============================================================
var isHTML5;
if (swiffyJS != "") {
...
//backup
	noFlash = true;
	document.write('<a onmouseover="onHoverMaster();" target="'+vl_html_target+'" href="'+advurl+'"><img src="' + dcgifSSL + '" border=0></a>');
}
//============================================================
//============================================================
//============================================================
