	...
	for( var num=0; num < opt.numSlides; num++ ) {
		...
		if( num == 0 && opt.isExpandable == true && num == opt.expandSlide-1 ) {
			...
			if ( num == opt.expandSlide-1 && opt.isExpandable == true ) {
			    ...
			    <img id="'+ad.clientID+'_nav_'+(num+1)+'_1" class="vl-slidenavbtn" src="/images/navbar/video.png" onclick="'+ad.clientID+'_adbox.'+'slider.slide(0, 300)">\n\
			    <img id="'+ad.clientID+'_nav_'+(num+1)+'_2" class="vl-slidenavbtn" src="/images/navbar/map.png" onclick="'+ad.clientID+'_adbox.'+'slider.slide(1, 300)">\n\
			    <img id="'+ad.clientID+'_nav_'+(num+1)+'_3" class="vl-slidenavbtn" src="/images/navbar/social.png" onclick="'+ad.clientID+'_adbox.'+'slider.slide(2, 300)">\n\
