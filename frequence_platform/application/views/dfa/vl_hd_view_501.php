			...
			if ( num == opt.expandSlide-1 && opt.isExpandable == true ) {
				...
				if(opt.useSpecLogo == 'true'){
				    ...
				    //console.log(speclogo);
						slides += '<div id="'+ad.clientID+'_specimage_'+num+'" onclick="'+ad.clientID+'_adbox.'+'onEnrollButtonClick();" style="width:'+ad.width+'px;position:absolute;left:0px;top:0px;height:'+opt.speclogoheight+'px;text-align:'+opt.speclogoalign+';">';
