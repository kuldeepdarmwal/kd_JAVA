...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="/images/linker.png">
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
            ...
            <a class="brand" style="width:20px;height:10px;padding:0px;margin:0px;padding-top:9px;padding-right:7px;" href="/director"><img src="/images/linker.png"></a>
            <a class="brand"  href="/director"><img src="/ring_files/images/vantage-local-white-logo.png"></a>
            <div class="nav-collapse collapse">
         	<div class="navbar-text pull-right">
              <img style="padding-right:10px" height="32" width="32" src="<?php echo 'https://s3.amazonaws.com/brandcdn-assets/avatars/avatar_'.$user_id.'.png';?>" /> <a href="#" class="navbar-link"><?php echo $firstname." ".$lastname;?></a>
            </div>
                <ul class="nav">
                    <li id="adsets_menu" ><a href="#"><i class="icon-edit icon-white"></i><span style="text-decoration: line-through;"> Ad Sets</span></a></li>
                    <li id="tags_memnu"><a href="/tag"><i class="icon-bookmark icon-white"></i><span> RTG Tags</span></a></li>
                    ...
                    <li id="publish_menu" class="active"><a href="#"><i class="icon-book icon-white"></i><span> Publisher</span></a></li>
                    <li id="ad_groups_menu"><a href="/adgroups"><i class="icon-list-alt icon-white"></i><span> Ad Groups</span></a></li>
                    <li id="healthcheck_menu"><a href="/campaign_health"><i class="icon-heart icon-white"></i><span> Health Check</span></a></li>
                </ul>
            </div><!--/.nav-collapse -->
        </div>
      </div>
...
<!-- Le javascript
    ...
    <script src="../bootstrap/bootstrap/assets/js/bootstrap-popover.js"></script>
...
function load_new_advertiser_name_script()
{
    set_advertiser_status(null);
     ...
     { 
        var new_advertiser_load_result = load_new_advertiser_ajax(document.getElementById("new_advertiser_name").value);
...
function load_new_advertiser_ajax(the_name)
{   
