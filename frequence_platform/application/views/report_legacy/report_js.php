...
<script type="text/javascript">
	...
	var g_first_advertiser = <?php echo $advertiser_selected; ?>
...
<script type="text/javascript" src="/assets/js/report_legacy.js?v=<?php echo CACHE_BUSTER_VERSION; ?>"></script>
<script type="text/javascript" src="//maps.googleapis.com/maps/api/js?key=AIzaSyAVqHsbdM1Thk9WK5JlfbQIfor-2CKlq2g&libraries=places,visualization"></script>
<script type="text/javascript" src="/assets/js/report_legacy_heatmaps.js"></script>