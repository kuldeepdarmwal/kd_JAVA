...
_html2canvas.Parse = function ( images, options ) {
    ...
    if (doc.createRange) {
        ...
        /*
        wkhtmltopdf's headless browser does not support getBoundingClientRect apparently,
        so this needs to be commented out for the auto snapshot feature to work.
...
html2canvas = function( elements, opts ) {
    ...
    options = {
        ...
        // preload options
        proxy: "/html2canvas_proxy/proxy", //"http://vl-image-editor.appspot.com/",//"http://html2canvas.appspot.com/",
