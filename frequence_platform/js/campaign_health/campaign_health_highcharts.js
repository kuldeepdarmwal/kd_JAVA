...
function show_detail_modal(campaign_id, start, end, raw_title){
	//alert('/campaign_health/get_campaign_details_id/?campaign_id=' +campaign_id+'&start='+start+'&end='+end);
    ...
    document.getElementById('modal_detail_header').innerHTML = title;
    $.ajax({
        ...
        success: (function (msg) {
            ...
            {
                vl_show_ajax_response_data_errors(msg, "Something went wrong: ")
            }  
        }),
