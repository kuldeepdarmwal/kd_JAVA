    ...
    $.fn.smartWizard = function(action) {
        ...
        return this.each(function(){
                ...
                function init(){
				  ...
				  btFinish = $('<a>'+options.labelFinish+'</a>').attr("href","#").addClass("buttonSave");
                  btNext = $('<a>'+options.labelNext+'</a>').attr("href","#").addClass("buttonNext").css ("padding-top", "5px").append('<img id="nextarrow" src="/ring_files/images/previousarrow.png" width="10px" height="10px" />');
                  btPrevious = $('<a>'+options.labelPrevious+'</a>').attr("href","#").addClass("buttonPrevious").css ("padding-top", "5px").prepend('<img id="previousarrow" src="/ring_files/images/previousarrow.png" width="10px" height="10px" />');
                  ...
                  if(!options.cycleSteps){                
                    if(0 >= curStepIdx){
                     ...
                     // $(btPrevious).removeClass("disable");
                    	$(btPrevious).css("display", "inline-block");
                    }
                    if((steps.length-1) <= curStepIdx){
                      $(btNext).css("display", "none");
                    }else{
                      $(btNext).css("display", "inline-block");                    }
                  }
                  // Finish Button 
