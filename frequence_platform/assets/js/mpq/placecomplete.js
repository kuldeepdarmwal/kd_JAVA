            ...
            GooglePlacesAPI.getPredictions(query.term, requestParams)
                .done(function(aprs) {
                    var results = $.map(aprs, function(apr) {
                        ...
                        apr["id"] = apr["place_id"];// This is changed from the original file: https://github.com/stephjang/placecomplete/issues/14
                        return apr;
                    });
        ...
        "change": function(evt) {
            ...
            GooglePlacesAPI.getDetails(evt.added)
                .done(function(placeResult) {
                    evt.added.coordinates = placeResult.geometry.location;
                    // Basically, I can't figure out how to get this trigger to work
                    // with our version of select2.
