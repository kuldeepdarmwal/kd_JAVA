...
var GooglePlacesAPI = {
    ...
    init: function(el) {
        ...
        if (window.google && google.maps && google.maps.places) {
            ...
            var google_access_token_rfp_io = window.google_access_token_rfp_io || 'api_key_error';
            $.ajax({
                url: "https://maps.googleapis.com/maps/api/js?key=" + google_access_token_rfp_io + "&libraries=places&sensor=false&callback=initPlacecomplete",
                dataType: "script",
                cache: true
            });
        }
