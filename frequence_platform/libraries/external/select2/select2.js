...
(function ($, undefined) {
    ...
    AbstractSelect2 = clazz(Object, {
		...
		//Will 2016-05-24
		//changed width here for positionDropdown to be native javascript since container.outerHeight() returns width in INTEGER values and the container can have float values.  This was affecting pages like rfp and io mainly when interacting with materialize css row/col (which uses percentage widths and was the cause for the widths as floats).
