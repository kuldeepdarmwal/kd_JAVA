...
<VirtualHost *:80>
  ...
  ServerName  review-5.vantagelocaldev.com
  ServerAlias *.review-5.vantagelocaldev.com

  <Directory />
        Options FollowSymLinks
        AllowOverride FileInfo
  </Directory>
  <Directory /var/review_servers/review-5/public/vantagelocal.com>
  ...
  # Index file and Document Root (where the public files are located)
   ...
   DocumentRoot /var/review_servers/review-5/public/vantagelocal.com



  # Custom log file locations
  LogLevel warn
  ErrorLog  /var/review_servers/review-5/public/log/error.log
  CustomLog /var/review_servers/review-5/public/log/access.log combined
