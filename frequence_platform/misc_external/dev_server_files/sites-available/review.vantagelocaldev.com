...
<VirtualHost *:80>
  ...
  ServerName  review.vantagelocaldev.com
  ServerAlias *.review.vantagelocaldev.com

  <Directory />
        Options FollowSymLinks
        AllowOverride FileInfo
  </Directory>
  <Directory /var/review_servers/dev_review/public/vantagelocal.com>
  ...
  # Index file and Document Root (where the public files are located)
   ...
   DocumentRoot /var/review_servers/dev_review/public/vantagelocal.com



  # Custom log file locations
  LogLevel warn
  ErrorLog  /var/review_servers/dev_review/public/log/error.log
  CustomLog /var/review_servers/dev_review/public/log/access.log combined
