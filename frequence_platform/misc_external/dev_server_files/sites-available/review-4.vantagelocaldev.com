...
<VirtualHost *:80>
  ...
  ServerName  review-4.vantagelocaldev.com
  ServerAlias *.review-4.vantagelocaldev.com

  <Directory />
        Options FollowSymLinks
        AllowOverride FileInfo
  </Directory>
  <Directory /var/review_servers/review-4/public/vantagelocal.com>
  ...
  # Index file and Document Root (where the public files are located)
   ...
   DocumentRoot /var/review_servers/review-4/public/vantagelocal.com



  # Custom log file locations
  LogLevel warn
  ErrorLog  /var/review_servers/review-4/public/log/error.log
  CustomLog /var/review_servers/review-4/public/log/access.log combined
