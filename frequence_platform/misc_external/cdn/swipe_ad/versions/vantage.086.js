...
function Vantage( ad, options ) {
	...
	this.setupMap = function() {
		...
		{
		    mapbox.addEventListener("click", function(event){event_check(false)}, false);
		    mapbox.addEventListener("mousedown", function(event){event_check(false)}, false);
		    mapbox.addEventListener("touchstart", function(event){event_check(false)}, false);
		} 
		else if(mapbox.attachEvent)
		{
		    mapbox.attachEvent("onclick", function(event){event_check(false)});
		    mapbox.attachEvent("mousedown", function(event){event_check(false)});
		    mapbox.attachEvent("touchstart", function(event){event_check(false)});
		}    
	...
	function setupNavbar(){
	   ...
	   // console.log(vl.videoSlideNum)
		...
		for(var j = 0; j < 3; j++)
		{
		    ...
		    current_button.addEventListener("click", function(event){event_check(false)}, false);
		    } 
		    else if(current_button.attachEvent)
		    {
		     current_button.attachEvent("onclick", function(event){event_check(false)});
		    } 
		}
	    }
	...
	function setupSocial() {
		...
		{
		    document.getElementById( ad.clientID + '_' +'social-holder' ).addEventListener("click", function(event){event_check(false)}, false);
		} else if(document.getElementById( ad.clientID + '_' +'social-holder' ).attachEvent)
		{
		  document.getElementById( ad.clientID + '_' +'social-holder' ).attachEvent("onclick", function(event){event_check(false)});  
		}
	}
	// Share on Facebook
