...
function Vantage( ad, options ) {
	...
	this.setupMap = function() {
		...
		{
		    mapbox.addEventListener("click", function(event){if(event.stopPropagation){event.stopPropagation();} else {event.cancelBubble = true; event.returnValue = false;}}, false);
		    mapbox.addEventListener("mousedown", function(event){if(event.stopPropagation){event.stopPropagation();} else {event.cancelBubble = true; event.returnValue = false;}}, false);
		    mapbox.addEventListener("touchstart", function(event){if(event.stopPropagation){event.stopPropagation();} else {event.cancelBubble = true; event.returnValue = false;}}, false);
		} 
		else if(mapbox.attachEvent)
		{
		    mapbox.attachEvent("onclick", function(event){if(event.stopPropagation){event.stopPropagation();} else {event.cancelBubble = true; event.returnValue = false;}});
		    mapbox.attachEvent("mousedown", function(event){if(event.stopPropagation){event.stopPropagation();} else {event.cancelBubble = true; event.returnValue = false;}});
		    mapbox.attachEvent("touchstart", function(event){if(event.stopPropagation){event.stopPropagation();} else {event.cancelBubble = true; event.returnValue = false;}});
		}    
	...
	function setupNavbar(){
	   ...
	   // console.log(vl.videoSlideNum)
		...
		for(var j = 0; j < 3; j++)
		{
		    ...
		    current_button.addEventListener("click", function(event){if(event.stopPropagation){event.stopPropagation();} else {event.cancelBubble = true; event.returnValue = false;}}, false);
		   // current_button.addEventListener("mousedown", function(event){event.stopPropagation();}, false);
		    //current_button.addEventListener("touchstart", function(event){event.stopPropagation();}, false);
		    } 
		    else if(current_button.attachEvent)
		    {
		     current_button.attachEvent("onclick", function(event){if(event.stopPropagation){event.stopPropagation();} else {event.cancelBubble = true; event.returnValue = false;}});
		   // current_button.attachEvent("mousedown", function(event){event.stopPropagation();});
		   // current_button.attachEvent("touchstart", function(event){event.stopPropagation();});
		    } 
		}
	    }
	...
	function setupSocial() {
		...
		{
		    document.getElementById( ad.clientID + '_' +'social-holder' ).addEventListener("click", function(event){if(event.stopPropagation){event.stopPropagation();} else {event.cancelBubble = true; event.returnValue = false;}}, false);
		} else if(document.getElementById( ad.clientID + '_' +'social-holder' ).attachEvent)
		{
		  document.getElementById( ad.clientID + '_' +'social-holder' ).attachEvent("onclick", function(event){if(event.stopPropagation){event.stopPropagation();} else {event.cancelBubble = true; event.returnValue = false;}});  
		}
	}
	// Share on Facebook
