...
b.Date > '2012-11-10'
GROUP BY Site ORDER BY Imps DESC  LIMIT 16";
...
//	$second_result = mysql_query($top_site_query);
   ...
   <td><textarea rows="5" cols="50" id="cookie_list"></textarea></td>
	<td><p style="font-size:70%;">URLs to fetch (one site per line)<br> cookies</p></td>

   </tr>
   <tr>
   <td>Sites: </td>
   <td><textarea rows="5" cols="50" id="sites_list"></textarea></td>
	<td><p style="font-size:70%;">URLs of sites to <br> search for ad on<br>(one per line, actual URL of pages)</p></td>
