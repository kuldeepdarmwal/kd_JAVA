...
//require_once $_SERVER["DOCUMENT_ROOT"].'/cdn/cloudfiles_exceptions.php';
//require_once $_SERVER["DOCUMENT_ROOT"].'/cdn/cloudfiles_http.php';
...
class CF_Object
{
    ...
    function _guess_content_type($handle) {
        ...
        if (function_exists("finfo_open")) {
            ...
            //$local_magic = $_SERVER["DOCUMENT_ROOT"]."/share/magic";        
